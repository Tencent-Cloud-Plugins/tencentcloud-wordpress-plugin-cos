...
?>
<!--add style file-->
<link rel="stylesheet" type="text/css" href="<?php echo TENCENT_WORDPRESS_COS_PLUGIN_CSS_URL;?>bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo TENCENT_WORDPRESS_COS_PLUGIN_CSS_URL;?>admin.css">
            ...
            <div class="col-lg-9">
                <form id="wpcosform_cos_info_set" data-ajax-url="<?php echo $ajax_url ?>" name="tcwpcosform" method="post" class="bs-component">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-2 lable_padding_left" for="inputDefault">自定义密钥</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-lg-2" for="inputDefault">所属地域</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-lg-2">空间名称</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-lg-2" for="inputDefault">访问域名</label>
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-2 lable_padding_left" for="inputDefault">自动重命名</label>
                    ...
                    <!-- Setting Option no_local_file-->
                    <div class="row form-group">
                        <label class="col-form-label col-lg-2 lable_padding_left" for="inputDefault">不在本地保存</label>
                        <div class="custom-control custom-switch div_custom_switch_padding_top">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-2 lable_padding_left" for="inputDefault">禁止缩略图</label>
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-lg-2 lable_padding_left" for="inputDefault">数据万象</label>
                        <div class="custom-control custom-switch div_custom_switch_padding_top">
    ...
    <div class="row">
        <div class="col-lg-9">
            <form id="wpcosform_attachment_sync"  name="tcwpcosform_attachment_sync" method="post" class="bs-component">
                <div class="form-group">
                    <label class="col-form-label col-lg-2" for="inputDefault">附件同步</label>
    ...
    <div class="row">
        <div class="col-lg-9">
            <form id="wpcosform_cos_info_replace"  name="tcwpcosform_cos_info_replace" method="post" class="bs-component">
                <div class="form-group">
                    <label class="col-form-label col-lg-2" for="inputDefault">一键替换</label>
