...
class TencentWordpressCOS extends TencentWordpressCosBase {
    ...
    {
        if ($file == plugin_basename(TENCENT_WORDPRESS_COS_PLUGIN_DIR . 'tencentcloud-plugin-cos.php')) {
    ...
    public static function tcwpcosAddSettingPage()
    {
        ...
        add_submenu_page('TencentWordpressPluginsCommonSettingPage','对象存储','对象存储', 'manage_options', 'tencent_wordpress_plugin_cos', array('TencentWordpressCOS', 'tcwpcosSettingPage'));
    }
