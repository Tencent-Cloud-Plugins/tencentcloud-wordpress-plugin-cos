<?php
/**
 * Plugin Name: tencentcloud-plugin-cos
...
defined('TENCENT_WORDPRESS_COS_VERSION') or define('TENCENT_WORDPRESS_COS_VERSION', '1.0.0');
...
defined('TENCENT_WORDPRESS_COS_NAME') or define('TENCENT_WORDPRESS_COS_NAME', 'tencentcloud-plugin-cos');
defined('TENCENT_WORDPRESS_COS_SHOW_NAME') or define('TENCENT_WORDPRESS_COS_SHOW_NAME', 'tencentcloud-plugin-cos');
defined('TENCENT_WORDPRESS_COS_NICK_NAME') or define('TENCENT_WORDPRESS_COS_NICK_NAME', '腾讯云对象存储（COS）插件');
defined('TENCENT_WORDPRESS_PLUGIN_URL') or define('TENCENT_WORDPRESS_PLUGIN_URL', plugins_url() . DIRECTORY_SEPARATOR);
defined('TENCENT_WORDPRESS_COS_PLUGIN_URL') or define('TENCENT_WORDPRESS_COS_PLUGIN_URL', TENCENT_WORDPRESS_PLUGIN_URL . basename(__DIR__) . DIRECTORY_SEPARATOR);
defined('TENCENT_WORDPRESS_COS_PLUGIN_ASSETS_URL') or define('TENCENT_WORDPRESS_COS_PLUGIN_ASSETS_URL', TENCENT_WORDPRESS_COS_PLUGIN_URL . 'assets' . DIRECTORY_SEPARATOR);
defined('TENCENT_WORDPRESS_COS_PLUGIN_JS_URL') or define('TENCENT_WORDPRESS_COS_PLUGIN_JS_URL', TENCENT_WORDPRESS_COS_PLUGIN_ASSETS_URL . 'javascript' . DIRECTORY_SEPARATOR);
defined('TENCENT_WORDPRESS_COS_PLUGIN_CSS_URL') or define('TENCENT_WORDPRESS_COS_PLUGIN_CSS_URL', TENCENT_WORDPRESS_COS_PLUGIN_ASSETS_URL . 'css' . DIRECTORY_SEPARATOR);

defined('TENCENT_WORDPRESS_PLUGINS_COMMON_URL') or define('TENCENT_WORDPRESS_PLUGINS_COMMON_URL', TENCENT_WORDPRESS_COS_PLUGIN_URL . 'common' . DIRECTORY_SEPARATOR);
